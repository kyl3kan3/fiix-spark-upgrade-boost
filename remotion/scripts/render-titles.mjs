...
const composition = await selectComposition({ serveUrl: bundled, id: "titles", puppeteerInstance: browser });
console.log(`Rendering ${composition.durationInFrames} frames`);
await renderMedia({
  composition, serveUrl: bundled, codec: "h264",
  outputLocation: "/tmp/titles.mp4",
  puppeteerInstance: browser, muted: true, concurrency: 4,
