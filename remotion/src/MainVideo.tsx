...
const BLOCKS: Block[] = [
  {
    ...
    props: {
      ...
      title: "Facility excellence, engineered.",
      subtitle:
        "An intelligent CMMS for the people who actually keep the lights on.",
      variant: "intro",
    },
  },
  {
    ...
    props: {
      eyebrow: "Chapter 01",
      title: "Meet the landing.",
      subtitle: "Editorial design. Real outcomes.",
      variant: "chapter",
    },
  },
  { kind: "shot", dur: 230, props: { src: "shots/home-1.png", kicker: "01 · Hero", caption: "Built for modern facility operations.", direction: "in" } },
  { kind: "shot", dur: 220, props: { src: "shots/home-2.png", kicker: "02 · Features", caption: "Work orders. PMs. Assets. One place.", direction: "left" } },
  { kind: "shot", dur: 220, props: { src: "shots/home-3.png", kicker: "03 · Request Portal", caption: "A free, branded portal for tenants.", direction: "right" } },
  { kind: "shot", dur: 200, props: { src: "shots/home-4.png", kicker: "04 · White-glove", caption: "We onboard your first PMs — free.", direction: "in" } },
  { kind: "shot", dur: 230, props: { src: "shots/home-5.png", kicker: "05 · Pricing", caption: "One flat fee. Add the whole crew.", direction: "out" } },
  {
    kind: "title",
    dur: 60,
    props: {
      ...
      subtitle: "Calm UI. Sharp data. Zero spreadsheet sprawl.",
      variant: "chapter",
    },
  },
  { kind: "shot", dur: 260, props: { src: "shots/dashboard-1.png", kicker: "06 · Daily snapshot", caption: "Your morning, in one screen.", direction: "in" } },
  { kind: "shot", dur: 260, props: { src: "shots/workorders-1.png", kicker: "07 · Work orders", caption: "Right away. Up next. Done.", direction: "left" } },
  { kind: "shot", dur: 260, props: { src: "shots/assets-1.png", kicker: "08 · Asset registry", caption: "Every machine. Every history.", direction: "right" } },
  { kind: "shot", dur: 240, props: { src: "shots/calendar-1.png", kicker: "09 · PM scheduler", caption: "Plan the work. Stop the breakdowns.", direction: "in" } },
  {
    kind: "title",
    dur: 60,
    props: {
      ...
      subtitle: "One platform — four ways to use it.",
      variant: "chapter",
    },
  },
  { kind: "shot", dur: 230, props: { src: "shots/features-1.png", kicker: "10 · Features", caption: "Everything a maintenance team needs.", direction: "out" } },
  { kind: "shot", dur: 230, props: { src: "shots/solutions-1.png", kicker: "11 · Solutions", caption: "Work orders. PMs. Facilities. Fleet.", direction: "left" } },
  {
    kind: "title",
    dur: 180,
    props: {
