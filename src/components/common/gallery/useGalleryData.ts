...
/** Resolves the signed-in user and their company_id, or nulls if unavailable. */
...
/**
 * react-query data layer for the photo gallery: the attachments query plus
 * upload / delete / reorder / update-caption mutations. Keeps ImageGallery
 * itself focused on presentation.
 */
