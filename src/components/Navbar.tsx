...
const Navbar = () => {
 ...
 {/* Mobile Menu Button */}
 <button
 className="md:hidden text-foreground shrink-0 -mr-1 p-1"
 ...
 {/* Mobile Menu */}
 {isMobileMenuOpen && (
 <div className="md:hidden bg-card absolute left-0 right-0 w-full p-4 shadow-lg animate-fade-in border-t border-border">
 <div className="flex flex-col space-y-4">
 <a href="/" className="flex items-center gap-2 pb-2 border-b border-border">
