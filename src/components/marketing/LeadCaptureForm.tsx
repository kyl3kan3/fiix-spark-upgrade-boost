  ...
  if (submitted) {
    return (
      <div className="p-8 rounded-2xl border border-gray-200 bg-white text-center">
        ...
        <h3 className="text-2xl font-semibold text-gray-900 mb-2">Thanks — message received.</h3>
        <p className="text-gray-700">A MaintenEase specialist will reach out within one business day.</p>
      </div>
    );
  }

  return (
    <form onSubmit={onSubmit} className="p-8 rounded-2xl border border-gray-200 bg-white">
      ...
      <div className="mt-6 flex items-center gap-3">
        ...
        <p className="text-xs text-gray-500">No spam. We only use this to reply to you.</p>
      </div>
    </form>
  );
};
