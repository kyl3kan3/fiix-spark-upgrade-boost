  ...
  return (
    <div className={cn("flex flex-wrap items-center gap-2", className)}>
      ...
      <a
        ...
        className={cn(
          "inline-flex items-center justify-center rounded-md border border-gray-200 bg-white text-gray-700 transition hover:border-maintenease-500 hover:text-maintenease-600",
          btnClass,
        )}
      >
      ...
      <Button
        ...
        className={cn(
          "border-gray-200 text-gray-700 hover:border-maintenease-500 hover:text-maintenease-600",
