...
const WeekView: React.FC = () => {
 ...
 <th className="border p-1 sm:p-2 bg-muted text-xs sm:text-sm font-medium">Mon</th>
 <th className="border p-1 sm:p-2 bg-muted text-xs sm:text-sm font-medium">Tue</th>
 <th className="border p-1 sm:p-2 bg-muted text-xs sm:text-sm font-medium">Wed</th>
 <th className="border p-1 sm:p-2 bg-muted text-xs sm:text-sm font-medium">Thu</th>
 <th className="border p-1 sm:p-2 bg-muted text-xs sm:text-sm font-medium">Fri</th>
 </tr>
 </thead>
 <tbody>
