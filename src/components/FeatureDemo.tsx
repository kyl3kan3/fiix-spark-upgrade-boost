    ...
    <div className="container mx-auto px-4 max-w-6xl">
      ...
      <div className="mb-8 flex flex-col md:flex-row md:items-end md:justify-between gap-4">
        <div>
          ...
          <h1 className="text-3xl md:text-4xl font-bold text-gray-900 mb-2">{feature.title}</h1>
          <p className="text-lg text-gray-600 max-w-2xl">{feature.description}</p>
        </div>
        <Button
          asChild
          ...
          {featureKeys
            ...
            .map((k) => (
              <Link
                ...
                className="px-4 py-2 rounded-full border border-gray-200 bg-white text-sm text-gray-700 hover:border-fiix-500 hover:text-fiix-700 transition-colors"
              >
                {k}
              </Link>
            ))}
