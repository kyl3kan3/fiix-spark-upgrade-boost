...
const RequestPortalSection = () => {
 ...
 <p className="text-sm text-foreground">Urgent requests fire instant push and email alerts to your on-call team. No more missed emergencies.</p>
 </div>
 </div>
 <div className="flex gap-3">
 ...
 <p className="text-sm text-foreground">Convert any incoming request into a fully populated work order with location, photos, and contact info.</p>
 </div>
 </div>
 <div className="flex gap-3">
 <div className="shrink-0 h-10 w-10 rounded-lg bg-maintenease-100 flex items-center justify-center">
 ...
 <p className="text-sm text-foreground">Tenants, staff, or the public can submit a request in 30 seconds — no app install, no account.</p>
 </div>
 </div>
 </div>
 ...
 <div className="h-9 rounded border border-border bg-muted px-3 flex items-center text-foreground">Leaking sink in break room</div>
 </div>
 <div>
 <p className="text-xs text-muted-foreground mb-1">Location</p>
 <div className="h-9 rounded border border-border bg-muted px-3 flex items-center text-foreground">Building B, 2nd floor</div>
 </div>
