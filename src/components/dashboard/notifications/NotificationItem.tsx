...
const NotificationItem: React.FC<NotificationItemProps> = ({ 
 ...
 return (
 <div 
 className={`p-4 border-b last:border-0 hover:bg-muted ${ notification.read ? "" : "bg-primary/10/30 dark:bg-primary/20" } relative transition-colors duration-200 group animate-fade-in`}
 >
