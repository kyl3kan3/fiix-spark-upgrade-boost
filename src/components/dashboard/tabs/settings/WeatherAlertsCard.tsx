    ...
    <Card className="dark:bg-gray-900 dark:border-gray-700 border-gray-200">
      ...
      <CardContent className="space-y-6">
        <div className="flex items-center justify-between p-4 rounded-lg bg-gray-50 dark:bg-gray-800 border dark:border-gray-600 border-gray-200">
          <div>
            <Label className="dark:text-white text-gray-900 font-medium">Enable temperature alerts</Label>
            <p className="text-sm text-gray-600 dark:text-gray-300">Master switch for your whole company.</p>
          </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          <div>
            <Label className="dark:text-white text-gray-900">Unit</Label>
          ...
          <div>
            <Label className="dark:text-white text-gray-900">Min temperature (°{unit})</Label>
            <Input
              type="number"
              value={minDisp}
          ...
          <div>
            <Label className="dark:text-white text-gray-900">Max temperature (°{unit})</Label>
            <Input
              type="number"
              value={maxDisp}
        ...
        <div className="pt-4 border-t dark:border-gray-700">
          <h4 className="font-medium dark:text-white text-gray-900 mb-2">Locations</h4>
          ...
          <div className="space-y-3">
            {locations.map((loc) => (
              <div
                key={loc.id}
                className="grid grid-cols-1 sm:grid-cols-[1fr_120px_120px_auto] gap-2 sm:items-center p-3 rounded-md border dark:border-gray-700"
              >
                <div className="font-medium dark:text-white text-gray-900">{loc.name}</div>
                <Input
                  type="number"
                  step="0.0001"
                ...
                <div className="flex items-center gap-2 justify-end">
                  <span className="text-sm text-gray-600 dark:text-gray-300">Alerts</span>
                  <Switch
