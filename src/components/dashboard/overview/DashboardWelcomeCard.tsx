...
const DashboardWelcomeCard: React.FC<DashboardWelcomeCardProps> = ({
 ...
 return (
 <div className="mb-6 bg-card dark:bg-card p-4 md:p-6 rounded-xl shadow-sm border border-border dark:border-border animate-entry overflow-hidden">
 ...
 <p className="text-foreground dark:text-muted-foreground flex flex-wrap items-center gap-2">
