    ...
    <div className="space-y-3">
      {showCountWarning && (
        <Alert variant="destructive">
          ...
          <AlertDescription>
            Found {vendors.length} vendors but expected {expectedCount}. You may want to adjust
            your file format or expected count.
          </AlertDescription>
        </Alert>
      )}
      ...
      <div className="flex items-center gap-2">
        {expectedCount && (
          <Badge variant="outline">Expected: {expectedCount}</Badge>
        )}
