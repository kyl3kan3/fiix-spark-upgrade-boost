...
const DowntimeTrackingContent: React.FC = () => {
 ...
 <TabsTrigger value="assets" className="text-xs sm:text-sm whitespace-nowrap">Top Assets</TabsTrigger>
 </TabsList>
 ...
 <p className="text-sm text-muted-foreground">{asset.incidents} incidents</p>
 </div>
 </div>
 <div className="text-right">
 <p className="font-medium">{asset.hours}h downtime</p>
 <p className="text-sm text-muted-foreground">${asset.cost.toLocaleString()} cost</p>
 </div>
 </div>
 ))}
 </div>
