...
export const featureItems: FeatureItem[] = [
 ...
 icon: <ClipboardCheck className="h-12 w-12 p-2 bg-primary/10 text-primary rounded-lg" />,
 category: "core",
 ...
 icon: <Calendar className="h-12 w-12 p-2 bg-primary/10 text-primary rounded-lg" />,
 category: "core",
 ...
 icon: <Users className="h-12 w-12 p-2 bg-primary/10 text-primary rounded-lg" />,
 category: "advanced",
 ...
 icon: <BarChart2 className="h-12 w-12 p-2 bg-primary/10 text-primary rounded-lg" />,
 category: "reporting",
 ...
 icon: <Clock className="h-12 w-12 p-2 bg-primary/10 text-primary rounded-lg" />,
 category: "reporting",
