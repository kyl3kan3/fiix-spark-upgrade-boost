...
const AssetManagementContent: React.FC = () => {
 ...
 <div className="w-16 h-16 bg-secondary rounded-lg flex items-center justify-center mr-4">
 ...
 <p className="text-sm text-muted-foreground">Asset ID: A-001</p>
 </div>
 </div>
 ...
 <p className="text-sm text-foreground">Atlas Copco</p>
 </div>
 <div>
 <p className="text-sm font-medium">Model</p>
 <p className="text-sm text-foreground">GA 30+</p>
 </div>
 <div>
 <p className="text-sm font-medium">Serial Number</p>
 <p className="text-sm text-foreground">APC-2023-45678</p>
 </div>
 <div>
 <p className="text-sm font-medium">Installation Date</p>
 <p className="text-sm text-foreground">June 15, 2022</p>
 </div>
 </div>
 ...
 <p className="text-xs text-foreground">Type: {entry.type}</p>
 </div>
 ))}
 </div>
