 ...
 *,
 ...
 <h3 className="mt-2 text-sm font-medium text-foreground">Location not found</h3>
 ...
 <p className="text-foreground mt-2">{location.description}</p>
 )}
 </div>
 ...
 <p className="text-muted-foreground text-center py-4">No assets in this location</p>
 )}
 </CardContent>
 </Card>
 ...
 <p className="text-sm text-muted-foreground">{subLocation.description}</p>
 )}
 </Link>
 ))}
 </div>
 ) : (
 <p className="text-muted-foreground text-center py-4">No sub-locations</p>
 )}
 </CardContent>
 </Card>
 </div>
