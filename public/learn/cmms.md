...
A CMMS is software that keeps a list of your equipment and manages the work done on it — repairs, inspections, and recurring preventive tasks — so nothing depends on someone's memory or a spreadsheet.

### What does CMMS stand for?

CMMS stands for Computerized Maintenance Management System.

### What are CMMS systems used for?
...
An ERP runs the business — finance, purchasing, HR. A CMMS runs maintenance in operational detail. Many teams integrate the two so parts purchases and asset costs flow into the ERP while day-to-day maintenance stays in the CMMS.
...
- https://maintenease.com/learn/deferred-maintenance
